					...
					if(statusCode=="200")
					{
						 ...
						 $('#resendOTPclick').css('pointer-events', 'none');
						  ...
						  var mobile=cleanedPhoneNumber.replace(/\d(?=\d{4})/g, "x");
                           ...
                           console.log("cleaned code="+cleanedText);
...
function resendOTP(){
 ...
 $('#resendOTPclick').on('click', function() {
                              resendOTP();
                          });
